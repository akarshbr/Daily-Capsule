                ...
                : RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return NewsCard(
                          title: homeScreenController.newsModel.articles?[index].title.toString() ?? "",
                          author: homeScreenController.newsModel.articles?[index].author.toString() ?? "_",
                          description:
                              homeScreenController.newsModel.articles?[index].description.toString() ?? "",
                          ...
                          source:
                              homeScreenController.newsModel.articles?[index].source?.name.toString() ?? "",
                          content: homeScreenController.newsModel.articles?[index].content.toString() ?? "",
